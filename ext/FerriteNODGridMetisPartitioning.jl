...
module FerriteNODGridMetisPartitioning
...
"""
"""
function FerriteNODGrid.create_partitioning(grid::Grid{dim,C,T}, grid_topology::CoverTopology, n_partitions::Int, partition_alg::PartitioningAlgorithm.Ext{Metis}) where {dim,C,T}
...
end # module FerriteNODGridMetisPartitioning
